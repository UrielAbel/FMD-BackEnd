...
const deletePodcastsValidator = [
    body('uri')
    .exists().withMessage('Es requerido un uri para identificar el podcast a eliminar. No se ha proporcionado')
...
module.exports = { deletePodcastsValidator }
